...
public class Test_StreamConnect_Logout_9 {
	...
	public void Logout9()
	{
       ...
       // System.setProperty("webdriver.ie.driver" , "C:\\Program Files (x86)\\Internet Explorer\\IEDriverServer_64.exe");
		...
		wait.until (ExpectedConditions.visibilityOfElementLocated(By.id("ContentPlaceHolder1_MainContentNest_ibtnFavorites")));
		driver.findElement(By.id("ContentPlaceHolder1_MainContentNest_ibtnFavorites")).click();
