...
public class Test_StreamConnect_Logout_4 {
	...
	public static void main(String[] args)
	{
       ...
       // System.setProperty("webdriver.ie.driver" , "C:\\Program Files (x86)\\Internet Explorer\\IEDriverServer_64.exe");
		...
		wait.until (ExpectedConditions.visibilityOfElementLocated(By.id("ContentPlaceHolder1_MainContentNest_MainContent_hlkLiveStream")));
		driver.findElement(By.id("ContentPlaceHolder1_MainContentNest_MainContent_hlkLiveStream")).click();
