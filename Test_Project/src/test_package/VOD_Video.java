  ...
  public void Video() {
     ...
     //System.setProperty("webdriver.ie.driver" , "C:\\Program Files (x86)\\Internet Explorer\\IEDriverServer_64.exe");
      ...
      WebDriver driver = new SafariDriver();
		...
		wait.until (ExpectedConditions.visibilityOfElementLocated(By.id("ContentPlaceHolder1_MainContentNest_grdvodGallery_ibtnGallery_0")));
		driver.findElement(By.id("ContentPlaceHolder1_MainContentNest_grdvodGallery_ibtnGallery_0")).click();
