...
public class Test_StreamConnect_Logout_10 {
	...
	public void Logout10()
	{
       ...
       // System.setProperty("webdriver.ie.driver" , "C:\\Program Files (x86)\\Internet Explorer\\IEDriverServer_64.exe");
		...
		wait.until (ExpectedConditions.visibilityOfElementLocated(By.id("ContentPlaceHolder1_MainContentNest_ibtnShareManager")));
		driver.findElement(By.id("ContentPlaceHolder1_MainContentNest_ibtnShareManager")).click();
