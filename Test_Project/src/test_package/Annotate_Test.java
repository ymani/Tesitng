...
public class Annotate_Test {
  ...
  public void Annotate() 
  {
     ...
     //System.setProperty("webdriver.ie.driver" , "C:\\Program Files (x86)\\Internet Explorer\\IEDriverServer_64.exe");
		...
		wait.until (ExpectedConditions.visibilityOfElementLocated(By.id("ContentPlaceHolder1_MainContentNest_grdvodProcedures_grdITPanel_0")));
		driver.findElement(By.id("ContentPlaceHolder1_MainContentNest_grdvodProcedures_grdITPanel_0")).click();
		
		wait.until (ExpectedConditions.visibilityOfElementLocated(By.id("ContentPlaceHolder1_MainContentNest_btnViewCase")));
		driver.findElement(By.id("ContentPlaceHolder1_MainContentNest_btnViewCase")).click();
		
		wait.until (ExpectedConditions.visibilityOfElementLocated(By.id("ContentPlaceHolder1_MainContentNest_grdvodGallery_ibtnGallery_3")));
		driver.findElement(By.id("ContentPlaceHolder1_MainContentNest_grdvodGallery_ibtnGallery_3")).click();
		
		wait.until (ExpectedConditions.elementToBeClickable(By.id("ContentPlaceHolder1_MainContentNest_btnEditOr")));
		driver.findElement(By.id("ContentPlaceHolder1_MainContentNest_btnEditOr")).click();
